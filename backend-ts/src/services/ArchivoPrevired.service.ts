      ...
      async (manager: EntityManager) => {
        ...
        const trabajadores = await manager
          ...
          .leftJoinAndSelect(
            ...
            "informacionLaboral",
            "informacionLaboral.negocio_id = :negocioId AND informacionLaboral.isContratoActivo = true",
            { negocioId }
          )
          ...
          .leftJoinAndSelect(
            "trabajador.configuracionArchivoPrevired",
        ...
        const dtos = await Promise.all(
          trabajadores.map(async (trabajador) => {
            ...
            const ccaf = trabajador.informacionLaboral[0].negocio.ccaf;
            ...
            const tasaSis =
              trabajador.configuracionArchivoPrevired![0].tasasis || 0;
            ...
            const tipoTrabajador = informacionLaboral.tipoTrabajador;
            ...
            const valorCotizacionIsapre = informacionLaboral.cotizacionPactada
              ? informacionLaboral.cotizacionPactada *
                trabajador.configuracionArchivoPrevired![0].ufcalculos
              : 0;
            ...
            if (salud.codigoSalud === 7) {
              ...
              dto.cotizacionPactada = informacionLaboral.cotizacionPactada || 0; // Campo 79
              dto.numeroFUN = informacionLaboral?.numeroFun || ""; // Campo 76
              dto.tipoMoneda = trabajador.informacionLaboral[0].tipoMoneda || 0; // Campo 78
