...
export default class ArchivoPreviredDTO {
  ...
  @IsIn(["M", "m", "F", "f"], { message: "Género del trabajador debe ser M o F." })
  @Length(1, 1, {
  ...
  @IsNumber(
    { maxDecimalPlaces: 4 },
    { message: "Aporte Trabajador Cesantía debe tener hasta 4 decimales." }
  )
  @IsOptional()
  ...
  @IsNumber(
    { maxDecimalPlaces: 4 },
    { message: "Aporte Empleador Cesantía debe tener hasta 4 decimales." }
  )
  @IsOptional()
