// InformacionPrevisional.js
import { Flex, Stack } from "@chakra-ui/react";
import PropTypes from "prop-types";
import { memo } from "react";
import { InputField, SelectField, Section } from "./ComponentesFormularios";

const InformacionPrevisional = memo(({ isOpen, onToggle, onChange, data, errors, onBlur }) => (
  <Section title="Información Previsional" isOpen={isOpen} onToggle={onToggle}>
    <Stack spacing={4}>
      ...
      {/* Validar si la salud seleccionada no es Fonasa */}
      {data.salud && data.salud !== "Fonasa" && (
        <>
          ...
          <InputField
            ...
            type="number"
            flex={1}
            error={errors.cotizacionPactada}
              onBlur={onBlur}
          />
          <SelectField
            id="tipoMoneda"
